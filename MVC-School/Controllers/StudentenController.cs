...
namespace MVC_School.Controllers
{
    public class StudentenController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentID,StudentVName,StudentAName,Adres,Woonplaats")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentID,StudentVName,StudentAName,Adres,Woonplaats")] Student student)
        {
